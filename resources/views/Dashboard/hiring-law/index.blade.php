    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <a href="{{route('admin.hiring_law.create')}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="{{route('admin.hiring_law.edit',$row->id)}}">
                                                <button class="btn btn-warning waves-effect waves-light"> <i class="fa fa-map-pin mr-1"></i> <span>تعديل</span> </button>
                                            </a>
                                            <form class="delete" data-id="{{$row->id}}" method="POST" action="{{ route('admin.hiring_law.destroy',[$row->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
