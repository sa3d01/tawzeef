                    ...
                    <div class="card-box">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    <td>{{$row->title_ar}}</td>
                                    <td>{{\App\Models\BlogSeen::where('blog_id',$row->id)->count()}}</td>
                                    <td>
                                        <div class="button-list">
                                            ...
                                            <form class="delete" data-id="{{$row->id}}" method="POST" action="{{ route('admin.blog.destroy',[$row->id]) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
